...
func TestIsAvailable(T *testing.T) {
	...
	cases := []IsAvailableTestCase{
		...
		{argument: "candidate", expected: false, err: fmt.Errorf("Failed to contact %s at https://github.com/candidate with error %s", client, ErrorFetcher.err), fetcher: ErrorFetcher},
	}
