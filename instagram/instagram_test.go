...
import (
	...
	"github.com/barolab/candidate/instagram"
)
...
func TestIsAvailable(T *testing.T) {
	...
	cases := []IsAvailableTestCase{
		...
		{argument: "candidate", expected: false, err: fmt.Errorf("Request to https://www.instagram.com/candidate/ failed: %s", ErrorFetcher.err), fetcher: ErrorFetcher},
	}
